...
--%>
<%
    System.out.println("In page sign in admin");
    ...
    <div class="signin-container my-3 p-4 rounded" >
        <div class="d-flex flex-column align-items-center">
            ...
            <div class="container-fluid">
                <form action="<%=String.format("%s/signin/manage/admin",request.getServletContext().getContextPath())%>" method="post" id="loginForm">
                    <input type="hidden" name="csrfToken" id="csrfToken" >
                    <div class="mb-3">
                        <input type="text" class="form-control input-field" name="email" id="email" value="" placeholder="Email" required>
                    </div>
                    <div class="mb-3">
                        <input type="password" class="form-control input-field" id="password" name="password" value="" placeholder="Mật khẩu" required>
                    </div>
